...
ggsave("example/plots/histogram_intervals_corrected_night_unc.pdf", height = 3, width = 5)
...
ggsave("example/plots/histogram_intervals_corrected_day_unc.pdf", height = 3, width = 5)

...
# test <- .getDFs("example/results/interval hour/objects.Rdata", "hour")
...
ggsave("example/results/sensitivity_estimates.pdf", width = 12, height = 12)
...
ggsave("example/results/sensitivity.pdf", width = 12, height = 12)

library(ggpubr)
p_both <- ggarrange(p_pars, p_pmps, ncol = 1)
ggsave("example/results/sensitivity_example.pdf", width = 12, height = 6)
...
ggsave("example/results/sensitivity_prior.pdf", width = 12, height = 12)
